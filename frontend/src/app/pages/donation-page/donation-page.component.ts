...
import { DonationService, ImpactFund, DonationAmountOption, DonationImpactItem } from '../../services/donation_service';
...
export class DonationPageComponent implements OnInit {
  ...
  selectedPackage?: DonationAmountOption;
  ...
  onPackageSelected(option: DonationAmountOption): void {
  ...
  // Its because of the icons but we will use awesome font in the final version forsho
